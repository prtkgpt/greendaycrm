...
import { Plus, Search, Phone, Mail, MapPin, MoreVertical, Trash2, Edit } from 'lucide-react';
import Modal from '../components/Modal';

export default function Customers() {
  const { data: customers, loading, refetch } = useApi<Customer[]>('/customers');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingCustomer) {
        await apiRequest(`/customers/${editingCustomer.id}`, { method: 'PUT', body: formData });
      } else {
        await apiRequest('/customers', { method: 'POST', body: formData });
      }
                ...
                <div className="flex items-center gap-2 ml-4">
                  <div className="text-right text-sm">
                    ...
                    <div className="text-gray-500">
                      {customer.completed_jobs || 0} completed
                    </div>
                  </div>
